...
SELECT ENAME , JOB, SAL FROM emp_oracle;

SELECT ENAME , JOB, SAL*12 ANNUAL_SALARY FROM emp_oracle;

SELECT ENAME , JOB, SAL*12 ANNUAL_SAL, SAL*12*0.10 ANNUAL_TAX FROM emp_oracle;
